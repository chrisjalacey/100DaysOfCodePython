...
userInputInteger = int(input("Enter a integer: "))
userInputFloat = float(input("Enter a float: "))
userInputString = input("Enter a string: ")

print (f"Integer: {userInputInteger}")
print (f"Float: {userInputFloat}")
print (f"String: {userInputString}")
